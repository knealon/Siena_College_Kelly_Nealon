...
\title{Development of a turn-key cloud chamber using a webcam data logger.}

\author{Matt Bellis}
\email{mbellis@siena.edu} % optional
\author{Kelly Nealon}
\author{Jessica Muenkel}
\author{Meghan Harrington}
\author{Gary LaMountain}
%\email{gm17alle@siena.edu} % optional
